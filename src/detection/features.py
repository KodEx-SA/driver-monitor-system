...
Note: these raw ratios are *not* the final fatigue signal — Step 5
...
# Order matters — see the docstrings on eye_aspect_ratio() and
# mouth_aspect_ratio() for what each position is expected to be.
LEFT_EYE_INDICES = (362, 385, 387, 263, 373, 380)
RIGHT_EYE_INDICES = (33, 160, 158, 133, 153, 144)
# Outer lip landmarks, not inner. MediaPipe's inner-mouth landmarks (13, 14,
# 78, 308) become unreliable during a wide yawn — the inner mouth turns into
# a dark, low-contrast cavity the model struggles to lock onto. Outer lip
# points stay visually distinct (skin-to-lip contrast) even at maximum
# jaw opening, so they track far more stably for MAR.
